...
const AnalyticsTab = () => {
	...
	return (
		<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-red-200'>
			...
			<motion.div
				className='bg-gray-600/60 rounded-lg p-6 shadow-lg'
...
const AnalyticsCard = ({ title, value, icon: Icon, color }) => (
	<motion.div
		className={`bg-red-800 rounded-lg p-6 shadow-lg overflow-hidden relative ${color}`}
		initial={{ opacity: 0, y: 20 }}
		animate={{ opacity: 1, y: 0 }}
